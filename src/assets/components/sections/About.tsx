            ...
            <div id="container">
                ...
                <div id="right">
                    <div id="top">
                        ...
                        <p id="description">
                            In 2009, our first team, Vex Robotics 1774 - Quantum Leap, was started. 
                            The following year, Oxford Academy established its OASTEM program. 
                            However, it wasn't until 2012 that FIRST Robotics Team 4079 - Quantum Leap was started. 
                            Over the last few years, we have begun hosting a FIRST Girl-Powered STEM day, as well as attending our district Steam-A-Palooza. 
                            2019 was our boom year, where we placed as Quarter-Finalists in Worlds (Carver), Finalists in Beach Blitz and the OCR, and Semi-Finalists in Battleship Blast. 
                            Recently, we've established an FTC team, meant to introduce robotics and STEM to younger students.
                        </p>
                    </div>
                    <div id="bottom">
                        {
